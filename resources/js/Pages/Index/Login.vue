<template>
    ...
    <div class="flex min-h-full bg-white dark:bg-slate-800 flex-1 flex-col justify-center px-6 py-8 lg:px-8">
        ...
        <form class="space-y-6" action="#" method="POST">
          ...
          <div>
            <Link href="/dashboard" class="flex w-full justify-center rounded-md bg-blue-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">Sign in </Link>
        ...
        <p class="mt-10 text-center text-sm text-gray-500">
          Not a member?
          {{ ' ' }}
          <Link href="/signup" class="font-semibold leading-6 text-blue-500 hover:text-blue-600">Sign Up</Link>
        </p>
      </div>
    </div>
  </template>
