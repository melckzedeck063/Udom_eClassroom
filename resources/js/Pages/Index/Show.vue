<template>
    ...
    <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-8 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm shadow-xl bg-slate-200 dark:bg-slate-700 py-2 px-3 rounded-lg">
        ...
        <p class="mt-10 text-center text-sm text-gray-500">
          Not a member?
          {{ ' ' }}
          <a href="#" class="font-semibold leading-6 text-blue-500 hover:text-blue-600">Sign Up</a>
        </p>
      </div>
    </div>
  </template>
